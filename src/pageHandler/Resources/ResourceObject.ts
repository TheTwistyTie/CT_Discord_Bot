...
import OrganizatoinData from "../../resources/organizations/OrganizationData";
import guildIdSchema from "../../schema/guildId-schema";
import editResource from "../../resources/resources/editResource";
...
export default class ResourceObject {
    ...
    constructor(embedData: ResourceData, guild: Guild, userID: string, userName: string) {
        this.data = embedData;
        this.guild = guild;
        this.userID = userID
    ...
    async showOrganziation() {
        if(this.#showingOrganization) {
            ...
            let orgData = new OrganizatoinData(organization.name, this.guild.id)
